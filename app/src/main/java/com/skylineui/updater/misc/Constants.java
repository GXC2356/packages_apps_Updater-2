 ...
 */
package com.skylineui.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.skylineui.base.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.build.product";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.skylineui.buildtype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "skylineui.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "skylineui.updater.uri";
